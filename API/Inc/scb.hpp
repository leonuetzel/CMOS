#pragma once
...
#if defined(CORTEX_M0) || defined(CORTEX_M0P) || defined(CORTEX_M3) || defined(CORTEX_M7)
	#include "defines.hpp"
	...
	class SCB
	{
		...
		public:
			...
			inline uint16 get_active_interruptVector();
	...
	inline uint16 SCB::get_active_interruptVector()
	{
		#if defined(CORTEX_M3) || defined(CORTEX_M7)
