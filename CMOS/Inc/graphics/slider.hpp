...
constexpr inline void Slider::set_function_onChangeMyPage(f_element onChangeMyPageFunction)
{
...
constexpr inline Element::f_element Slider::get_function_onChangeMyPage() const
{
