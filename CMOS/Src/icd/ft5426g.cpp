...
namespace ICD
{
	...
	uint8 FT5426G::register_read(REG address) const
	{
	...
	feedback FT5426G::register_write(REG address, uint8 data)
	{
		//	Send Start Condition
	...
	I_TouchController::e_touchGuesture FT5426G::getTouchGuesture()
	{
	...
	uint8 FT5426G::getNumberOfTouchPoints()
	{
	...
	Pair<Vec2, I_TouchController::e_touchEvent> FT5426G::getTouchPointInformation(uint8 index)
	{
