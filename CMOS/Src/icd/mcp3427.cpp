...
namespace ICD
{
	...
	uint8 MCP3427::read_configurationRegister()
	{
	...
	MCP3427::MCP3427(I_I2C& i2c, bool a0, bool a1, bool a2)
		:	m_i2c(i2c),
			m_address(0x68),
	...
	feedback MCP3427::set_conversionMode(e_conversionMode mode)
	{
	...
	feedback MCP3427::set_channel(uint8 channel)
	{
	...
	feedback MCP3427::set_sampleRate(e_sampleRate sampleRate)
	{
	...
	feedback MCP3427::set_gain(e_gain gain)
	{
		if(m_gain == gain)
		{
			return(OK);
